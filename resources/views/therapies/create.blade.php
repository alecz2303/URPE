...
<head>
    ...
    <title>Nueva terapia — URPE Gestión Clínica</title>
    ...
    <div class="mx-auto flex max-w-5xl items-center justify-between px-6 py-4 lg:px-8">
        <div class="flex items-center gap-4">
            ...
            <div class="hidden sm:block">
                ...
                <h1 class="text-xl font-bold">Nueva terapia</h1>
            </div>
        </div>
...
<main class="mx-auto max-w-5xl px-6 py-10 lg:px-8">
    <section class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200 sm:p-8">
        <div class="mb-7">
            ...
            <h2 class="mt-1 text-3xl font-bold">Crear terapia</h2>
            <p class="mt-2 text-sm leading-6 text-slate-500">Estos datos serán la fuente de verdad que usará la futura agenda para duración y recursos humanos requeridos.</p>
        </div>
